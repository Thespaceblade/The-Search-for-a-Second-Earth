    ...
    <>
      ...
      <section className="space-y-6 text-center">
        ...
        <div className="grid gap-4">
          <article className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-5 text-center">
            <h3 className="text-xl sm:text-2xl font-medium">Population pressure</h3>
            <div className="prose prose-invert max-w-prose mx-auto text-center">
          ...
          <article className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-5 text-center">
            <h3 className="text-xl sm:text-2xl font-medium">Resource strain</h3>
            <div className="prose prose-invert max-w-prose mx-auto text-center">
              <p className="text-slate-300">
          ...
          <article className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-5 text-center">
            <h3 className="text-xl sm:text-2xl font-medium">Sustainability gap</h3>
            <div className="prose prose-invert max-w-prose mx-auto text-center">
              <p className="text-slate-300">
